				...
				<div class="row">
					<div class="card shadow-sm">
						...
						<p style="width: 280px; pxwhite-space: normal; font-size: 15px"
							class="card-text pl-3 pt-3 pr-3 mx-1">라미♂의 FM 라디오 【홀로라이브 / 유키하나 라미】</p>
						<a href="#" class="card-link line-height:1em ml-4"
							style="font-size: 12px;">그래도이뻐 Stillpretty</a>
						<p class="text-left mx-4" style="font-size: 10px;">2022-11-23 00:55</p>
					</div>
				</div>
			</div>
		</div>
