                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label for="inputEmail" class="col-sm-3 control-label">
                            ID</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="inputEmail" placeholder="ID" required>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="inputTel2" placeholder="" required>
                        </div>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="inputTel3" placeholder="" required>
                        </div>
                    </div>
